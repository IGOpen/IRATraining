...
Kratu.prototype.setReportDefinition = function (report, opt_callback) {
    var kratu = this;
    if (!report)
        throw 'No reportDefinition supplied';
...
Kratu.prototype.renderReportHeadings_ = function () {
    ...
    for (var i = 0; i < signals.length; i++) {
        ...
        if (signal.headerEventHandlers) {
            kratu.addEventHandlers(signalHeader, signal.headerEventHandlers, { signal: signal });
        }
...
Kratu.prototype.assertAbleToClear = function () {
    var kratu = this;
    if (!kratu.getHasRendered())
        throw "Can't clear: Nothing rendered";
};
/**
...
Kratu.prototype.assertAbleToRender = function () {
    var kratu = this;
    if (!kratu.getRenderElement())
        throw "Can't render: No render element set";
    if (!kratu.getEntities())
        throw "Can't render: No entities set";
};
/**
